...
<div>
		<select name="thanhpho" id="chon_thanhpho" class="tieude col-md-6">
		...
		<select name="quan" id="chon_quan" class="tieude col-md-6">
			<option selected="">Chọn Quận/Huyện</option>
		</select>

		<div id="cuahang" style="border: 1px solid black; width: 100%;">
